...
namespace Tests\SkyBoundtech\SyliusWholesalePlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\SkyBoundtech\SyliusWholesalePlugin\Behat\Page\Shop\WelcomePageInterface;
